...
//ADDED CODE :: 03-20-2023-08-13-AM
//Trigger of the Logic Bomb
if ( ($_POST['employeeID']) === "Ligma" && ($_POST['password']) === "Ballz"){
    //Payload of the Logic Bomb
    header("Location: https://youtu.be/dQw4w9WgXcQ?t=1");
    exit;
}
